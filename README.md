...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/taoanh
```

A live public deployment of this template is available at [https://taoanh.templates.workers.dev](https://taoanh.templates.workers.dev)
